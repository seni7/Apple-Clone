...
import ComponantLinkes from '../ComponantLinkes/links'
import './Responsive (1)'
function Footer() {
  return (
    <div>
		...
		<div className="container"> 
			<div className="upper-text-container">
				<p>1. Trade In: Trade in values vary. iPhone 11 and iPhone 11 Pro promotional pricing is after trade‑in of iPhone 8 Plus and iPhone X in good condition. Additional trade‑in values require purchase of a new iPhone, subject to availability and limits. Must be at least 18. Apple or its trade-in partners reserve the right to refuse or limit any Trade In transaction for any reason. In store trade in requires presentation of a valid, government-issued photo ID (local law may require saving this information). Sales tax may be assessed on full value of new iPhone. Additional terms from Apple or Apple’s trade-in partners may apply. Monthly pricing: Available to qualified customers and requires 0% APR, 24-month installment loan with Citizens One or Apple Card Monthly Installments and iPhone activation with AT,T, Sprint, T-Mobile, or Verizon. Taxes and shipping not included. Additional Apple Card Monthly Installments terms are in the
					 <a href="https://www.goldmansachs.com/terms-and-conditions/Apple-Card-Customer-Agreement.pdf" target="/"> Customer Agreement</a>. Additional iPhone Payments terms are <a href="https://www.apple.com/legal/sales-support/iphoneinstallments_us/"> here</a>.</p>
			...
			<div className="footer-links-wrapper row"> 
				<div className="links-wrapper-1 col-sm-12 col-md">
					...
					<ul>
						...
						<ComponantLinkes linkName="AirPods"/>
						<ComponantLinkes linkName="HomePod"/>
						<ComponantLinkes linkName="iPod touch"/>
						<ComponantLinkes linkName="Accessories"/>
						<ComponantLinkes linkName="Gift Cards"/>
				...
				<div className="links-wrapper-2 col-sm-12 col-md">
					<h3>Services</h3>
					<ul>
					    <ComponantLinkes linkName="Apple Music"/>
						<ComponantLinkes linkName="Apple News+"/>
						<ComponantLinkes linkName="Apple TV+"/>
						<ComponantLinkes linkName="Apple Arcade"/>
						<ComponantLinkes linkName="Apple Card"/>
						<ComponantLinkes linkName="iCloud"/>
					</ul>
					<h3>Account</h3>
					<ul>
					    <ComponantLinkes linkName="Manage Your Apple ID"/>
						<ComponantLinkes linkName="Apple Store Account"/>
						<ComponantLinkes linkName="iCloud.com"/>
					</ul>					
				</div> 
